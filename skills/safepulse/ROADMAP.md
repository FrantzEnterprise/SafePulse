...
- [x] App UI with 6-step form flow
- [x] SMS notifications (sms: protocol)
- [x] Symptom editor
...
- More API key fields in Integrations tab (Twilio, SMTP, Stripe, etc.)
...
- White-label / re-branding for other locksmiths
- Onboarding wizard
- Export/import full tenant config
