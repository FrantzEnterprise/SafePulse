  ...
  return [
    ...
    },
    {
      ...
      symptoms: [
        ...
        { id: "dial_forgot_combo", label: "I forgot how to dial my combination!", points: 10, recommendation: "We understand it is confusing. Follow the exact dialing sequence provided. Left = counter-clockwise (numbers increase). Right = clockwise (numbers decrease). If you pass a target number you must start over.", causes: ["Confusing dialing direction", "Passing the target number", "Wrong sequence used"], remedy: "Rules: Left is counter-clockwise (numbers increase). Right is clockwise (numbers decrease). Any time you pass a number it counts as one rotation — this is the #1 mistake. If you pass your target number you cannot go back, you must start over.\n\nStandard Sequence:\n1. Dial your 1st number 4 times to the Left\n2. Dial your 2nd number 3 times to the Right\n3. Dial your 3rd number 2 times to the Left\n4. Dial to the right until you feel it engage and continue until you hit a dead stop (usually between 85 and 95)\n5. Turn your handle to open\n\nSimpler Sequence (some safes):\n• Dial 1st number 3 times to the Right\n• Dial 2nd number 2 times to the Left\n• Dial 3rd number 1 time to the Right\n• Turn your handle to open\n\nReverse Sequence (some safes):\n• Dial 1st number 3 times to the Left\n• Dial 2nd number 2 times to the Right\n• Dial 3rd number 1 time to the Left\n• Turn your handle to open", note: "I forgot how to dial is the most common issue people face with mechanical dial locks. Follow these sequences carefully and make sure you stop exactly on each target number.", parts: ["Practice dial", "Combination card", "Pen and paper to write down numbers"] },
      ],
    },
    {
